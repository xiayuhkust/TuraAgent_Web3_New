...
const AlertDialogDescription = React.forwardRef(({ className, ...props }, ref) => (<AlertDialogPrimitive.Description ref={ref} className={(0, utils_1.cn)("text-sm text-zinc-500 dark:text-zinc-400", className)} {...props}/>));
