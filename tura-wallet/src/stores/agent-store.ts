// Local storage for agents and workflows
...
export interface Workflow extends Agent {
...
export const officialAgents: Agent[] = [
  {
    name: 'WalletAgent',
    ...
    multiSigAddress: '',  // No multisig as it's a built-in agent
    chainId: 1337,
    status: 'OFFICIAL'
  }
];
...
export const getAgent = (address: string): Agent | undefined => {
...
export const getAllAgents = (): Agent[] => [...officialAgents, ...agents];
